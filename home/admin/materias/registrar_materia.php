...
// Obtener maestros (rol = 2) activos
$sqlMaestros = "
        ...
        <main class="content-area p-4">
            ...
            <div class="admin-form-card">
                ...
                <form action="procesar_registro_materia.php" method="POST">
                    ...
                    <!-- Horario: días + horas -->
                    <div class="mb-3">
                        <label class="form-label">Días de la materia</label>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <small class="text-muted ps-3">
                            El horario se formará automáticamente. Ejemplo: <strong>Lun-Mar 08:00-10:00</strong>
                        </small>
                    </div>
