            ...
            <div class="col-md-6 p-5">
                ...
                <div class="form-card1 p-4 fade-in">
                    ...
                    <form action="<?= BASE_URL ?>includes/registrar_usuario.php" method="POST">
                        ...
                        <label class="form-label custom-label" for="nombres">Nombres</label>
                        <input
                            type="text"
                            id="nombres"
                            name="nombres"
                        ...
                        <label class="form-label custom-label mt-3" for="ap_paterno">Apellido paterno</label>
                        <input
                            type="text"
                            id="ap_paterno"
                            name="ap_paterno"
                        ...
                        <label class="form-label custom-label mt-3" for="ap_materno">Apellido materno</label>
                        <input
                            type="text"
                            id="ap_materno"
                            name="ap_materno"
                        ...
                        <label class="form-label custom-label mt-3" for="correo">Correo</label>
                        <input
                            type="email"
                            id="correo"
                            name="correo"
                        ...
                        <label class="form-label custom-label mt-3" for="password">Contraseña</label>
                        <input
                            type="password"
                            id="password"
                            name="password"
                        ...
                        <label class="form-label custom-label mt-3" for="password2">Confirmar contraseña</label>
                        <input
                            type="password"
                            id="password2"
                            name="password2"
